...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::pause_service_run,
            commands::resume_service_run,
            commands::get_service_report,
            commands::list_service_reports,
            commands::delete_report,
            commands::clear_all_reports,
            // Report editing commands (agent)
            commands::edit_report_finding,
            commands::add_report_finding,
            commands::remove_report_finding,
            commands::set_report_summary,
            commands::set_service_analysis,
            commands::set_report_health_score,
            commands::get_report_statistics,
